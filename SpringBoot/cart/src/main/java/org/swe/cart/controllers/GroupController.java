...
public class GroupController {
    ...
    @PreAuthorize("@groupService.canUserManageLists(#customUserDetails.getUsername(), #groupId)")
    public ResponseEntity<ShopList> addListToGroup(@AuthenticationPrincipal CustomUserDetails customUserDetails,
